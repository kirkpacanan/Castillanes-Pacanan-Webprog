...
export default function GuestLanding({ onSignIn }) {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-black text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(229,9,20,0.25),_transparent_55%)]" />
      <div className="relative z-10 mx-auto flex min-h-screen w-[min(1280px,94%)] flex-col py-10 md:py-14">
        <header className="flex items-center justify-between">
          <div className="flex items-center gap-3 text-xs font-semibold uppercase tracking-[0.3em] text-red-500">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="rounded-full border border-white/20 px-4 py-2 text-sm font-semibold text-white/80 transition hover:border-red-500 hover:text-white"
            >
              Sign in
            </button>
            <button
        ...
        <section className="flex flex-1 flex-col items-center justify-center text-center">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            ...
            <button
              type="button"
              onClick={() => { setShowAuth(true); setIsSignUp(false); }}
              className="rounded-full border-2 border-white/20 px-8 py-4 text-base font-semibold text-white/80 transition hover:border-red-500 hover:text-white"
            >
              Sign in
            </button>
          </div>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-4">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-white/15 bg-black/60 px-4 py-3 text-white outline-none ring-red-500/30 transition focus:ring-2"
                required
              />
              {isSignUp && (
                <>
              ...
              <div className="mt-2 flex gap-3">
                ...
                <button
                  type="button"
                  onClick={() => setShowAuth(false)}
                  className="rounded-full border border-white/20 px-4 py-3 text-sm font-semibold text-white/80"
                >
                  Cancel
                </button>
              </div>
